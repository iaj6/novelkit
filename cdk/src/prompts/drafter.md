...
- **Useful while drafting:** `query_facts` (what's already established about an entity — cheaper than re-reading the whole ledger) and `resolve_entity` (find an entity's stable id by name).
